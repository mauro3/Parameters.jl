...
To enforce constraints on the values, it's possible to use `@assert`s or `@smart_asserts`[^1]
...
[^1]: `@smart_assert` is defined in [SmartAsserts.jl](https://github.com/MrVPlusOne/SmartAsserts.jl/tree/main).
